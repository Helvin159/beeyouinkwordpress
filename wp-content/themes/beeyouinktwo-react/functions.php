...
function beeyou_files(){
  ...
  // ************************************ 
  // My Style
  wp_enqueue_style('styles', get_theme_file_uri('./static/css/main.03f4d76b.css'));
  ...
  // ************************************ 
  // Main Script
  wp_enqueue_script('beeYouData-script', get_theme_file_uri('./static/js/main.e87ce93c.js'), NULL,'1.0',true );
