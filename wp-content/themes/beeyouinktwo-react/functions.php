...
function beeyou_files(){
  ...
  // ************************************ 
  // My Style
  wp_enqueue_style('styles', get_theme_file_uri('./static/css/main.028e2cbc.css'));
  ...
  // ************************************ 
  // Main Script
  wp_enqueue_script('beeYouData-script', get_theme_file_uri('./static/js/main.d1af93a5.js'), NULL,'1.0',true );
