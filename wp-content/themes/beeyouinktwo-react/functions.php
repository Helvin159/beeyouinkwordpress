...
function beeyou_files(){
  ...
  // ************************************ 
  // My Style
  wp_enqueue_style('styles', get_theme_file_uri('./static/css/main.d01be9dc.css'));
  ...
  // ************************************ 
  // Main Script
  wp_enqueue_script('beeYouData-script', get_theme_file_uri('./static/js/main.fcd634a2.js'), NULL,'1.0',true );
